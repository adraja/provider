...
$form->addElement(new Element\HTML("<img src='Nutriligence.png' height='160'>/><h3>Login to NufitScan Provider</h3><a href='contacttogetaccess.php' style='text-decoration:underline'>Contact to get access</a>"));
